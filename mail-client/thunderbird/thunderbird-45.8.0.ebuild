...
inherit flag-o-matic toolchain-funcs mozconfig-v6.45 autotools pax-utils check-reqs nsplugins mozlinguas-v2 xdg-utils gnome2-utils mercurial
...
IUSE="bindist crypt hardened kde ldap kernel_linux lightning +minimal mozdom selinux"
...
src_compile() {
	mkdir -p "${BUILD_OBJ_DIR}" || die "mkdir failed"
