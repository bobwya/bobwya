...
# @FUNCTION: xorg-3-r1_src_unpack
# @DESCRIPTION:
# Simply unpack source code.
xorg-3-r1_src_unpack() {
...
# @FUNCTION: xorg-3-r1_reconf_source
# @DESCRIPTION:
# Run eautoreconf if necessary, and run elibtoolize.
xorg-3-r1_reconf_source() {
	debug-print-function ${FUNCNAME} "$@"
...
# @FUNCTION: xorg-3-r1_src_prepare
# @DESCRIPTION:
# Prepare a package after unpacking, performing all X-related tasks.
xorg-3-r1_src_prepare() {
	debug-print-function ${FUNCNAME} "$@"
...
# @FUNCTION: xorg-3-r1_flags_setup
# @DESCRIPTION:
# Set up CFLAGS for a debug build
xorg-3-r1_flags_setup() {
	debug-print-function ${FUNCNAME} "$@"
...
# @FUNCTION: xorg-3-r1_src_configure
# @DESCRIPTION:
# Perform any necessary pre-configuration steps, then run configure
xorg-3-r1_src_configure() {
	debug-print-function ${FUNCNAME} "$@"
...
# @FUNCTION: xorg-3-r1_src_compile
# @DESCRIPTION:
# Compile a package, performing all X-related tasks.
xorg-3-r1_src_compile() {
	debug-print-function ${FUNCNAME} "$@"
...
# @FUNCTION: xorg-3-r1_src_install
# @DESCRIPTION:
