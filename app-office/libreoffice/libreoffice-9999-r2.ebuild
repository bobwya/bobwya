...
if [[ ${PV} != *9999* ]]; then
	...
	PDEPEND=">=app-office/libreoffice-l10n-4.4.0.0"
fi
...
PATCHES=(
    ...
    "${FILESDIR}/${PN}-4.4.0.3-system-pyuno.patch"
)
...
pkg_pretend() {
	...
	if [[ ${PV} == *9999* ]]; then
		ewarn "Translations are not reliable on live ebuilds of ${PN} (app-office/libreoffice-l10n)"
	fi
}
