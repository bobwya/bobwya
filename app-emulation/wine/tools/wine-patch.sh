...
# Global variables
wine_versions_new="1.8_rc1-r2 1.8_rc2-r2 1.8_rc3-r2 1.8_rc4-r2 1.8-r2 1.8.1-r2 1.8.2-r1 1.8.3-r1 1.9.0-r2 1.9.1-r2 1.9.2-r2 1.9.3-r2 1.9.4-r2 1.9.5-r2 1.9.6-r2 1.9.7-r2 1.9.8-r1 1.9.9-r1 1.9.10-r1 1.9.11-r1 1.9.12-r1 1.9.13-r1 1.9.14-r1 1.9.15-r1 1.9.16 9999"
#wine_versions_staging_supported="${wine_versions_new}"

wine_versions_staging_supported="1.8_rc* 1.8.1 1.8.2 1.8.3 1.9.0 1.9.1 1.9.2 1.9.3 1.9.4 1.9.5 1.9.6 1.9.7 1.9.8 1.9.9 1.9.10 1.9.11 1.9.12 1.9.13 1.9.14 1.9.15 9999"
