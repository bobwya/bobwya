...
IUSE="+abi_x86_32 +abi_x86_64 +alsa capi cups custom-cflags dos elibc_glibc +fontconfig +gecko gphoto2 gstreamer kerberos ldap +mono mingw netapi nls odbc openal opencl +opengl osmesa pcap +perl prelink prefix pulseaudio +realtime +run-exes samba scanner sdl2 selinux +ssl test +threads +truetype udev +udisks +usb v4l vkd3d vulkan +X +xcomposite xinerama"
