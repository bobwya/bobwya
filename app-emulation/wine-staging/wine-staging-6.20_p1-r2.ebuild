...
IUSE="+abi_x86_32 +abi_x86_64 +alsa capi cups custom-cflags dos elibc_glibc ffmpeg +fontconfig +gecko gphoto2 gstreamer +jpeg kerberos kernel_FreeBSD ldap +mono mingw netapi nls odbc openal opencl +opengl osmesa oss pcap +perl pipelight prelink prefix pulseaudio +realtime +run-exes samba scanner sdl2 selinux +ssl test +threads +truetype udev +udisks +unwind +usb v4l vaapi vkd3d vulkan +X +xcomposite xinerama"
