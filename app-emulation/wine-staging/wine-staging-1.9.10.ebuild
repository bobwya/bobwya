...
if [[ ${MY_PV} == "9999" ]]; then
	...
	SRC_URI="${SRC_URI}
		https://github.com/bobwya/${STAGING_HELPER%-*}/archive/${STAGING_HELPER##*-}.tar.gz -> ${STAGING_HELPER}.tar.gz"
else
	SRC_URI="${SRC_URI}
...
RDEPEND="${COMMON_DEPEND}
	...
	gecko? ( app-emulation/wine-gecko:2.47_beta1[abi_x86_32?,abi_x86_64?] )
