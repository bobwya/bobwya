...
IUSE="+abi_x86_32 +abi_x86_64 +alsa capi cups custom-cflags dos elibc_glibc faudio +fontconfig +gcrypt +gecko gphoto2 gsm gstreamer +jpeg kerberos +lcms ldap +mono mingw mp3 ncurses netapi nls odbc openal opencl +opengl osmesa pcap +perl pipelight +png prelink prefix pulseaudio +realtime +run-exes samba scanner sdl2 selinux +ssl test themes +threads +tiff +truetype udev +udisks +unwind v4l vaapi vkd3d vulkan +X +xcomposite xinerama +xml"
